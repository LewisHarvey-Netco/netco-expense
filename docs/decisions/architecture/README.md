...
These ADRs record decisions about **how** we build the app: technology choices, patterns, boundaries, and implementation approaches.

| # | ADR | Status |
|---|-----|--------|
| 0001 | [Auth state via React Context](./0001-auth-state-via-react-context.md) | Accepted |
| 0002 | [Mock JSON authentication boundary](./0002-mock-json-authentication-boundary.md) | Accepted |
| 0003 | [Two-layer testing strategy](./0003-two-layer-testing-strategy.md) | Accepted |
